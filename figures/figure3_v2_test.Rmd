...
fig3_bottom_widths <- numeric(length(fig3_bottom_ss_grobs))
for (i in 1:length(fig3_bottom_panel_grobs)) {
  ...
  fig3_bottom_widths[i] <- fig3_bottom_panel_width
...
fig3_bottom_layout <- rbind(1:4)

fig3_bottom_grob <- arrangeGrob(grobs = fig3_bottom_panel_grobs,
...
fig3_heights <- c(fig3_height_padding_pt, fig3_heatmap_height_pt, fig3_height_padding_pt, fig3_height_padding_pt, fig3_bottom_height)
