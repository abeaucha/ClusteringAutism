...
for (i in 1:length(list_mouse_slices)) {
  ...
  for (j in 1:nslc) {
    ...
    fig3_bottom_ss_heights <- c(fig3_mouse_ss_height_pt, fig3_bottom_ss_padding_pt, fig3_human_ss_height_pt)
    
    # Generate slice series for cluster solution    
    ss <- arrangeGrob(list_mouse_slices[[i]][[j]],
                      black_rect_grob,
...
for (i in 1:length(fig3_bottom_panel_grobs)) {
  ...
  fig3_bottom_panel_grobs_list[ind_ss] <- fig3_bottom_ss_grobs[[i]]
  fig3_bottom_panel_grobs_list[ind_padding] <- list(zeroGrob())
  fig3_bottom_panel_grobs_list[ngrobs] <- list_polar_plots[i]
  # fig3_bottom_panel_grobs_list <- c(fig3_bottom_ss_grobs[[i]],
                                    # list_polar_plots[i])
  
  # Layout of the panel grid
  fig3_bottom_panel_layout <-  rbind(1:(ncols),
                                     rep(ngrobs, ncols))
...
fig3_height_padding_1_pt <- 8
fig3_height_padding_2_pt <- 32
fig3_height_padding_3_pt <- 19

fig3_heatmap_height_pt <- 205

# Figure 3 dimensions
fig3_widths <- c(26, fig3_width - 26)
fig3_heights <- c(fig3_height_padding_1_pt, fig3_heatmap_height_pt,
                  fig3_height_padding_2_pt, fig3_height_padding_3_pt, 
                  fig3_bottom_height)
...
# Figure 3 grob
fig3_grob <- arrangeGrob(zeroGrob(),
