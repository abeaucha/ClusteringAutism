...
```{r}
outfile_prefix <- "figure2_dev_1_2"
...
df_POND_cluster_labels <- readxl::read_excel(file.path(PROJECTPATH, "figures/v3/resources/POND_cluster_labels_colours.xlsx"))

df_HBN_cluster_labels <- readxl::read_excel(file.path(PROJECTPATH, "figures/v3/resources/HBN_cluster_labels_colours.xlsx"))
