...
df_cluster_groups <- df_cluster_groups %>% 
  semi_join(df_matches %>% 
  filter(match), by = "mouse_cluster_id")
```
...
list_mouse_slc_vps <- list(
  # K = 2
  list(x = rep(54, 2)/fig_width,
       y = (fig_height - c(91, 208))/fig_height,
       w = rep(0.15, 2),
       h = rep(0.07, 2)),
  # K = 7
  list(x = (24+c(277, 277, 248, 303, 277, 277, 277))/fig_width,
       y = (fig_height - c(52, 88, 116, 135.5, 173, 218, 259))/fig_height,
       w = rep(0.08, 7),
       h = rep(0.03, 7)),
  # K = 10
  list(x = (40+c(480, 504, 455, 504, 455, 504, 455, 480, 480, 480))/fig_width,
