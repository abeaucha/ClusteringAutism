...
# Export
outfile <- paste0("figure4_PONDSK_MICe_heatmap_nk8.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(500/72, "in"),
    height = unit(500/72, "in"))
...
# Export
outfile <- paste0("figure4_HBN_MICe_heatmap_nk8.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(500/72, "in"),
    height = unit(500/72, "in"))
...
# Export
outfile <- paste0("figure4_PONDSK_HBN_heatmap_nk8.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(500/72, "in"),
    height = unit(500/72, "in"))
...
outfile <- paste0("figure4_heatmap_nk8.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
