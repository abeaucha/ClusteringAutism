...
# Human anatomy
human_anat_file <- file.path(PROJECTPATH, "data/human/registration/v2/reference_files/model_0.8mm.mnc")
...
# Human mask
human_mask_file <- file.path(PROJECTPATH, "data/human/registration/v2/reference_files/mask_0.8mm.mnc")
