...
```{r}
files <- c("9994_CBCL_Pre_20220728.csv",
           "9994_CBCL_20220728.csv",
           "9994_SWAN_20220728.csv",
           "9994_SCQ_20220728.csv",
           "9994_RBS_20220728.csv",
           "9994_Vineland_20220728.csv",
           "9994_CELF_Full_5to8_20220728.csv",
           "9994_CELF_Full_9to21_20220728.csv",
           "9994_WISC_20220728.csv",
           "9994_WASI_20220728.csv")
...
There's really not much behavioural data for HBN.
...
variables <- df_complete_cases_hbn %>% 
  slice_max(order_by = n_complete, n = 7) %>% 
  pull(variable)

# Extract variable scores
cols <- c("ID", "nk2", variables)
...
outfile <- paste0("HBN_behavioural_mv_nk_2_scores.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(6, "in"),
    height = unit(6, "in"))
...
outfile <- paste0("HBN_behavioural_mv_nk_2_loadings.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(6, "in"),
    height = unit(6, "in"))
print(plt_mv_loadings)
dev.off()
```
...
outfile <- paste0("HBN_behavioural_mv_nk_2_roc.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(6, "in"),
    height = unit(6, "in"))
...
outfile <- paste0("POND_behavioural_mv_nk_2_scores.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(6, "in"),
    height = unit(6, "in"))
...
outfile <- paste0("POND_behavioural_mv_nk_2_loadings.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(6, "in"),
    height = unit(6, "in"))
...
outfile <- paste0("POND_behavioural_mv_nk_2_roc.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(6, "in"),
    height = unit(6, "in"))
