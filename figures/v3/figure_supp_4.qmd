...
```{r outputs}
outfile_prefix <- "figure_S4"
output_dir <- file.path("outputs", outfile_prefix)
if (!(dir.exists(output_dir))) {dir.create(path = output_dir, recursive = TRUE)}
```

```{r}
human_cluster_file <- file.path(PROJECTPATH, "data/human/derivatives/v3/700/clusters/resolution_3.0/clusters.csv")
...
df_cluster_labels <- readxl::read_excel(file.path(PROJECTPATH, "figures/v3/resources/POND_cluster_labels_colours.xlsx"))
...
list_vp_params <- list(
  # K = 2
  list(x = 46,
       y = fig_height_pt - c(147, 442)),
  # K = 3
  list(x = 102,
       y = fig_height_pt - c(117, 288, 461)),
  # K = 4
  list(x = 159,
       y = fig_height_pt - c(89, 240, 341, 485)),
  # K = 5
  list(x = 216,
       y = fig_height_pt - c(77, 215, 282, 360, 505)),
  # K = 6
  list(x = 274,
       y = fig_height_pt - c(78, 214, 259, 301, 360, 515)),
  # K = 7
  list(x = 329,
       y = fig_height_pt - c(78, 214, 259, 301, 360, 424, 515)),
  # K = 8
  list(x = 386,
       y = fig_height_pt - c(78, 200, 242, 285, 360, 405, 444, 516)),
  # K = 9
  list(x = 443,
       y = fig_height_pt - c(78, 196, 237, 275, 314, 360, 400, 440, 516)),
  # K = 10
  list(x = 500,
       y = fig_height_pt - c(78, 162, 202, 240, 280, 320, 360, 400, 438, 516))
