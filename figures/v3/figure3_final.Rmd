...
df_sankey_palette <- readxl::read_excel(file_palette)
# df_sankey_palette <- df_sankey_palette %>% 
#   rename(colour = colour_1)
...
df_human_sankey_annotations$y <- c(c(0.78, 0.35),
                                   c(0.78, 0.52, 0.35),
                                   c(0.78, 0.55, 0.35, 0.23),
                                   c(0.78, 0.55, 0.41, 0.30, 0.20),
                                   c(0.78, 0.62, 0.55, 0.46, 0.41, 0.28),
                                   c(0.78, 0.59, 0.46, 0.38, 0.27, 0.24, 0.20),
                                   c(0.78, 0.64, 0.56, 0.52, 0.49, 0.40, 0.23, 0.18), 
                                   c(0.78, 0.59, 0.50, 0.44, 0.370, 0.36, 0.23, 0.20, 0.20),
                                   c(0.78, 0.64, 0.50, 0.36, 0.30, 0.28, 0.25, 0.23, 0.22, 0.20))
...
grid.text(label = c("a", "b", "c", "d", "e"),
          x = unit(c(10.0, 10.0, 10.0, 298, 468), "bigpts"),
          y = unit(fig_height_pt - c(8, 262, 517, 517, 517), "bigpts"),
