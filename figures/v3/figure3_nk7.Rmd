...
# Export
outfile <- paste0("figure3_PONDSK_MICe_heatmap_nk7.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(500/72, "in"),
    height = unit(500/72, "in"))
...
# Export
outfile <- paste0("figure3_HBN_MICe_heatmap_nk7.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(500/72, "in"),
    height = unit(500/72, "in"))
...
# Export
outfile <- paste0("figure3_PONDSK_HBN_heatmap_nk7.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = unit(500/72, "in"),
    height = unit(500/72, "in"))
...
outfile <- paste0("figure3_heatmap_nk7.pdf")
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
