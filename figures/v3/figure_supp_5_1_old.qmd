...
df_cluster_labels <- readxl::read_excel(file.path(PROJECTPATH, "figures/v3/resources/HBN_cluster_labels.xlsx"))


df_cluster_labels <- df_cluster_labels %>%
  separate(col = "cluster_id_old", into = c("nk_old", "k_old"), remove = FALSE) %>%
...
```{r}
df_palette <- readxl::read_excel(file.path(PROJECTPATH, "figures/v3/resources/human_cluster_colours_HBN.xlsx"))
...
list_vp_params <- list(
  # K = 2
  list(x = 46,
       y = fig_height_pt - c(149, 443)),
  # K = 3
  list(x = 102,
       y = fig_height_pt - c(70, 288, 443)),
  # K = 4
  list(x = 159,
       y = fig_height_pt - c(70, 278, 420, 518)),
  # K = 5
  list(x = 216,
       y = fig_height_pt - c(70, 260, 373, 451, 536)),
  # K = 6
  list(x = 274,
       y = fig_height_pt - c(70, 208, 268, 328, 389, 487)),
  # K = 7
  list(x = 329,
       y = fig_height_pt - c(70, 145, 238, 350, 406, 493, 555)),
  # K = 8
  list(x = 386,
       y = fig_height_pt - c(70, 142, 198, 263, 369, 464, 510, 555)),
  # K = 9
  list(x = 443,
       y = fig_height_pt - c(70, 153, 231, 320, 366, 413, 451, 517, 555)),
  # K = 10
  list(x = 500,
       y = fig_height_pt - c(70, 153, 200, 245, 283, 366, 440, 480, 518, 555))
