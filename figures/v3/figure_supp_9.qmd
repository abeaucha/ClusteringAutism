...
plt_pond_univariate <- ggplot(df_kw_plt_pond, aes(x = factor(nk), y = fct_rev(label), 
  ...
  geom_point(shape = 21, stroke = 1.2, size = 2.5) +
...
fig_grob <- arrangeGrob(ggplotGrob(plt_pond_univariate),
                        zeroGrob(), #padding
...
#           x = unit(c(5, panel_width + padding_width + 5), "bigpts"),
#           y = unit(fig_height_pt - 8, "bigpts"),
