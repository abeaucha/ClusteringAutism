...
fig_border_padding_width <- 4
fig_border_padding_height <- fig_border_padding_width
...
mouse_neuro_tot_width <- fig_width - 2*fig_border_padding_width - 2*mouse_neuro_padding_width
...
mouse_nk6_neuro_ss_grob_1 <- sliceSeries(nrow = ss_nslices, ncol = 1, slices = mouse_slices) %>% 
  anatomy(mouse_anat_vol, low = mouse_anat_low, high = mouse_anat_high) %>% 
  overlay(list_mouse_centroids[["6"]][[1]], low = overlay_low, high = overlay_high, symmetric = TRUE) %>% 
  sliceSeries() %>% anatomy() %>% 
  overlay(list_mouse_centroids[["6"]][[2]], low = overlay_low, high = overlay_high, symmetric = TRUE) %>% 
  sliceSeries() %>% anatomy() %>% 
  overlay(list_mouse_centroids[["6"]][[3]], low = overlay_low, high = overlay_high, symmetric = TRUE) %>% 
  grobify()

mouse_nk6_neuro_ss_grob_2 <- sliceSeries(nrow = ss_nslices, ncol = 1, slices = mouse_slices) %>% 
  anatomy(mouse_anat_vol, low = mouse_anat_low, high = mouse_anat_high) %>% 
  overlay(list_mouse_centroids[["6"]][[4]], low = overlay_low, high = overlay_high, symmetric = TRUE) %>% 
  sliceSeries() %>% anatomy() %>% 
  overlay(list_mouse_centroids[["6"]][[5]], low = overlay_low, high = overlay_high, symmetric = TRUE) %>% 
  sliceSeries() %>% anatomy() %>% 
  overlay(list_mouse_centroids[["6"]][[6]], low = overlay_low, high = overlay_high, symmetric = TRUE) %>% 
  grobify()
...
mouse_neuro_grob <- arrangeGrob(mouse_nk2_neuro_grob,
                                ...
                                heights = unit(mouse_neuro_heights, units = "bigpts"))

fig_widths <- c(fig_border_padding_width, panel_tot_width, fig_border_padding_width)
...
mouse_neuro_heights <- panel_height

mouse_neuro_grob <- arrangeGrob(mouse_ss_grob_nk2,
...
panel_tot_width <- fig_width - 2*border_padding_height
