...
fig3_heatmap_patchwork_height_pt <- 215

# Heights of padding elements in bigpts
fig3_heatmap_padding_height_1_pt <- 37
...
for (i in 1:length(list_mouse_slices)) {
  ...
  for (j in 1:nslc) {
    ...
    fig3_neuro_ss_heights <- c(fig3_human_ss_height_pt, fig3_neuro_ss_padding_pt, fig3_mouse_ss_height_pt, fig3_neuro_ss_padding_pt, fig3_human_ss_height_pt)
