...
# Mouse-human cluster similarity matrix
...
fig2_heatmap <- ggplot(df_similarity_nk, 
       aes(x = human_cluster_id, y = mouse_cluster_id, fill = similarity)) + 
...
pdf(file = outfile, 
    width = unit(10, "in"),
    height = unit(10, "in"))
grid.draw(fig2_heatmap)
dev.off()
```

# Cluster similarity permutations
...
# Figure grob
fig2_grob <- arrangeGrob(fig2_ss_labels_grob,
