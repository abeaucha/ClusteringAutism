...
for (k in 1:nk_mouse) {
  pathways_file <- paste(mouse_pathways_file_prefix, nk_mouse, k, stringdb_score, sep = "_")
...
df_pathway_info <- list_mouse_pathways[[1]] %>% 
  filter(ID %in% pathway_ids) %>% 
  select(ID, pathway) %>% 
  distinct() %>% 
  arrange(pathway)
...
fig2_pathways_mouse <- ggplot(df_polar_plot, 
  ...
  scale_x_discrete(expand = expansion(), 
                   labels = df_pathway_info[["acronym"]]) + 
...
fig2_pathways_mouse_grob <- grid.force(ggplotGrob(fig2_pathways_mouse))
fig2_pathways_mouse_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["label"]] <- df_pathway_info[["acronym"]]

# Get initial label positions
fig2_pathways_mouse_labels_x <- fig2_pathways_mouse_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["x"]]
fig2_pathways_mouse_labels_y <- fig2_pathways_mouse_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["y"]]
...
fig2_pathways_mouse_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["x"]] <- fig2_pathways_mouse_labels_x
fig2_pathways_mouse_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["y"]] <- fig2_pathways_mouse_labels_y
```
...
# Fix polar axis labels
fig2_pathways_human_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["label"]] <- df_pathway_info[["acronym"]]

# Get initial label positions
fig2_pathways_human_labels_x <- fig2_pathways_human_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["x"]]
fig2_pathways_human_labels_y <- fig2_pathways_human_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["y"]]
...
# Set new label positions
fig2_pathways_human_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["x"]] <- fig2_pathways_human_labels_x
fig2_pathways_human_grob[["children"]][["panel.7-5-7-5"]][["children"]][[5]][["children"]][[1]][["children"]][[1]][["y"]] <- fig2_pathways_human_labels_y
```
...
# Mouse alpha value used to establish ground truth
alpha_mouse <- 1e-3
...
fig2_polar_padding_width_pt <- 10
fig2_polar_width_pt <- (fig2_ss_width_pt - fig2_polar_padding_width_pt)/2
fig2_polar_height_pt <- fig2_polar_width_pt
fig2_polar_legend_height_pt <- 26

# Figure 2 dimensions
fig2_widths <- c(fig2_polar_width_pt, fig2_polar_padding_width_pt, fig2_polar_width_pt, fig2_sim_dx_width_pt)
fig2_heights <- c(fig2_ss_height_pt, fig2_polar_height_pt, fig2_polar_legend_height_pt)
