...
annotation_ymax <- 4.1
annotation_labels_y <- annotation_ymax + c(0, -0.25, 0, -0.25, 0)
annotation_segments_yend <- annotation_labels_y + c(-0.2, -0.1, -0.2, -0.1, -0.2)
...
fig4_density <- ggplot(df_permutations, 
  ...
  annotate(geom = "text", 
           ...
           label = mat_labels_vals, 
           size = 2) +
  coord_cartesian(xlim = c(0.3, 1),
                  ylim = c(0, annotation_ymax + 0.3)) + 
...
#Row 12
fig4_layout[12, 2:6] <- 40
fig4_layout[12, 7:9] <- 39

#Row 13
fig4_layout[13, 2] <- 41
# fig4_layout[13, 3:10] <- 42
fig4_layout[13, 3:6] <- 42
fig4_layout[13, 7:9] <- 39
