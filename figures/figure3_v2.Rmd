...
fig3_ss_width <- fig3_heatmap_width
...
```{r}
# Generate polar plot
fig3_polar <- ggplot(df_polar_plot, 
                       aes(x = pathway, 
                           ymin = 0, ymax = E, 
                           group = cluster_id, 
                           fill = cluster_id, 
...
fig3_polar_grob <- grid.force(ggplotGrob(fig3_polar))
fig3_polar_panel_grob <- getGrob(fig3_polar_grob, "panel.7-5-7-5")
fig3_polar_panel_grob[["children"]][[5]][["children"]][[1]][["children"]][[1]][["label"]] <- pathway_terms
fig3_polar_legend_grob <- getGrob(fig3_polar_grob, "guides.3-3-3-3")
```
...
fig3_polar_height_nopadding <- 5.2

fig3_polar_legend_height <- 0.5

# Dimensions of individual plot panels
# fig3_polar_panel_height <- fig3_polar_height_nopadding/2
fig3_polar_panel_height <- fig3_polar_height - fig3_polar_legend_height
fig3_polar_panel_width <- fig3_polar_panel_height

# Grid cell dimensions
fig3_polar_heights <- c(fig3_polar_panel_height, fig3_polar_legend_height)
fig3_polar_widths <- c(0.25, fig3_polar_panel_width, 0.25)
...
fig3_polar_grob_grid <- arrangeGrob(rectGrob(gp = gpar(fill = NA)),
                                    fig3_polar_panel_grob,
                                    rectGrob(gp = gpar(fill = NA)),
                                    gTree(children = gList(rectGrob(gp = gpar(fill = NA)), fig3_polar_legend_grob)),
                                    layout_matrix = rbind(c(01, 02, 03),
                                                          c(NA, 04, NA)),
...
grid.draw(fig3_polar_grob_grid)
dev.off()
