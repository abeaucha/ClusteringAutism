...
# Combine mouse coronal slices into a slice series
fig2_ss_mouse_grobs <- vector(mode = "list", length = nk_mouse)
names(fig2_ss_mouse_grobs) <- names(fig2_ss_mouse_slice_grobs)
for (k in 1:nk_mouse) {
  fig2_ss_mouse_grobs[[k]] <- arrangeGrob(grobs = fig2_ss_mouse_slice_grobs[[k]],
                                          layout_matrix = matrix(1:ss_nrow),
...
# Combine human coronal slices into a slice series
fig2_ss_human_grobs <- vector(mode = "list", length = nk_human)
names(fig2_ss_human_grobs) <- names(fig2_ss_human_slice_grobs)
for (k in 1:nk_human) {
  fig2_ss_human_grobs[[k]] <- arrangeGrob(grobs = fig2_ss_human_slice_grobs[[k]],
                                          layout_matrix = matrix(1:ss_nrow),
                                          widths = unit(rep(1, ss_ncol)/ss_ncol, "npc"),
                                          heights = unit(rep(1, ss_nrow)/ss_nrow, "npc"))
}
...
```{r fig2-ss-mouse-labels}
fig2_ss_mouse_labels <- str_c(nk_mouse, 1:nk_mouse, sep = "-")
fig2_ss_mouse_labels_width <- 1/nk_mouse
fig2_ss_mouse_labels_x <- fig2_ss_mouse_labels_width/2 + 0:(nk_mouse-1)*fig2_ss_mouse_labels_width
fig2_ss_mouse_labels_grob <- gTree(children = gList(fig2_ss_black_rect_grob,
                                                    textGrob(label = fig2_ss_mouse_labels,
                                                             x = fig2_ss_mouse_labels_x,
                                                             gp = gpar(fontsize = 10,
                                                                       col = "white"))))
```

```{r fig2-ss-human-labels}
fig2_ss_human_labels <- str_c(nk_human, 1:nk_human, sep = "-")
fig2_ss_human_labels_width <- 1/nk_human
fig2_ss_human_labels_x <- fig2_ss_human_labels_width/2 + 0:(nk_human-1)*fig2_ss_human_labels_width
fig2_ss_human_labels_grob <- gTree(children = gList(fig2_ss_black_rect_grob,
                                                    textGrob(label = fig2_ss_human_labels,
                                                             x = fig2_ss_human_labels_x,
                                                             gp = gpar(fontsize = 10,
                                                                       col = "white"))))
```
...
# Legend width
fig2_ss_legend_width <- 0.5

# Padding width
fig2_padding_width <- 0.4

# Total width of slice series without padding
fig2_ss_width_nopadding <- fig2_ss_width - fig2_padding_width - fig2_ss_legend_width

# Number of slice series
n_ss <- length(fig2_ss_human_grobs) + length(fig2_ss_mouse_grobs)

# Width of one slice series
fig2_ss_width_1 <- fig2_ss_width_nopadding/n_ss

# Height of slice series
fig2_ss_height <- fig2_ss_width_1*ss_nrow

# Grid widths and heights
fig2_ss_widths <- c(rep(fig2_ss_width_1, nk_human), fig2_padding_width, rep(fig2_ss_width_1, nk_mouse), fig2_ss_legend_width)
fig2_ss_heights <- c(0.25, fig2_ss_height)
...
# List of grobs
fig2_ss_grobs_list <- c(
  list(fig2_ss_human_labels_grob), #1
  list(fig2_ss_black_rect_grob),   #2
  list(fig2_ss_mouse_labels_grob), #3
  list(fig2_ss_black_rect_grob),   #4
  fig2_ss_human_grobs,             #5-6
  list(fig2_ss_black_rect_grob),   #7
  fig2_ss_mouse_grobs,             #8-11
  list(fig2_ss_legend_grob)        #12
)

# Slice series grob
fig2_ss_grob <- arrangeGrob(grobs = fig2_ss_grobs_list,
                            layout_matrix = rbind(c(01, 01, 02, 03, 03, 03, 03, 04),
                                                  c(05, 06, 07, 08, 09, 10, 11, 12)),
                            widths = fig2_ss_widths_in,
                            heights = fig2_ss_heights_in)

# Slice series width and height
...
fig2_heatmap_panel_grob <- getGrob(fig2_heatmap_grob, "panel.7-5-7-5")
fig2_heatmap_legend_grob <- getGrob(fig2_heatmap_grob, "guides.3-3-3-3")
fig2_heatmap_xtitle_grob <- getGrob(fig2_heatmap_grob, "axis-t.6-5-6-5")
fig2_heatmap_xtext_grob <- getGrob(fig2_heatmap_grob, "xlab-t.5-5-5-5")
fig2_heatmap_ytitle_grob <- getGrob(fig2_heatmap_grob, "axis-l.7-4-7-4")
fig2_heatmap_ytext_grob <- getGrob(fig2_heatmap_grob, "ylab-l.7-3-7-3")
```
