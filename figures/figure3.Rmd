...
fig3_heatmap_grob <- arrangeGrob(gTree(children = gList(rectGrob(gp = gpar(fill = NA)), fig3_heatmap_1_xtitle_grob)),
...
fig3_polar_1_grob <- gTree(children = gList(fig3_polar_1_panel_grob,
                              textGrob("Test",
                                       x = 0.5, y = 0.8)))

grid.newpage()
grid.draw(fig3_polar_1_grob)
```
...
```{r}
fig3_width <- 8.5
fig3_polar_width <- fig3_width - fig3_heatmap_width - 0.2
...
fig3_polar_heights <- c(fig3_padding_width, fig3_polar_panel_height, fig3_padding_width, fig3_polar_panel_height, fig3_padding_width)

fig3_polar_widths <- c(fig3_polar_panel_width, fig3_polar_width - fig3_polar_panel_width)
...
# With gridlines
fig3_grob <- arrangeGrob(gTree(children = gList(rectGrob(gp = gpar(fill = NA)),fig3_heatmap_grob)),
                         rectGrob(gp = gpar(fill = NA)),
...
#                          layout_matrix = rbind(c(01, NA, 02),
#                                                c(NA, NA, NA)),
#                          widths = fig3_widths_in,
#                          heights = fig3_heights_in)
...
fig3_grob <- gTree(children = gList(rectGrob(width = fig3_width,
                                             height = fig3_height,
                                             gp = gpar(fill = NA)), 
                                    fig3_grob))
