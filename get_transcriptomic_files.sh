...
cp ${mouse_expr_dir}MouseExpressionMatrix_voxel_coronal_maskcoronal_log2_grouped_imputed.csv \
${outdir}MouseExpressionMatrix_voxel_coronal_log2_grouped_imputed.csv
