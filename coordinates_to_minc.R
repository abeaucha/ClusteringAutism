...
option_list <- list(
  make_option("--coordinates",
              type = "character",
              help = paste("Path to the file (.csv) containing the world",
                           "coordinates.")),
  ...
  make_option("--outfile",
              type = "character",
              help = paste("Path to the file (.mnc) in which to save",
                           "the output image.")),
  make_option("--type",
              type = "character",
              default = "labels",
              help = paste("One of {mask, labels} indicating the type of",
