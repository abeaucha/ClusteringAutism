...
model_list <- MakeModelList(
  scanbase_scans_file = "Data/Resources/scanbase_40um - Scans_31Jan22.csv",
...
TermsList <- c(
  "SYNAPTIC SIGNALING%GOBP%GO:0099536",
...
cl_filt <- GetValidGeneClusterList(
  Cluster_Dir = "Data/Outputs/Clusters_Paper",
  boot = "N",
  boot_pick = "100"
)

for (gscore in c(400, 700, 900, 950)) {
  GetGeneNeighbourhood(
    GeneScore = gscore,
    total_clusters = "10",
...
for (gscore in c(400, 700, 900, 950)) {
  GetSingleGeneNeighbourhood(
    GeneScore = gscore,
    total_clusters = "10",
    output_dir = "Data/Outputs/SingleGeneNeighbourhood_Paper/"
  )

  GetSingleGeneNeighbourhoodEnrichment(
    GeneScore = gscore,
    total_clusters = "10",
    Bader_List = "Data/Raw/Human_Reactome_October_01_2023_symbol.gmt",
  ...
  GetNeighbourhoodEnrichment_NotCluster(
    GeneScore = gscore,
    total_clusters = "10",
    Bader_List = "Data/Raw/Human_Reactome_October_01_2023_symbol.gmt",
    Neighbour_dir = "Data/Outputs/NeighbourhoodInfo_Paper/",
...
Score_Summary <- SummarizeAcrossScores(
  Pairwise_Dir = "Data/Outputs/ClusterPairwiseComp_Paper",
  total_clusters = "10"
)
