...
option_list <- list(
  make_option("--pipeline-dir",
              type = "character"),
  make_option("--registration-dir",
              type = "character"),
  make_option("--mask",
              type = "character"),
  make_option("--cluster-resolution",
              type = "numeric"),
  make_option("--cluster-nk-max",
              type = "numeric"),
  make_option("--cluster-metric",
              type = "character"),
  make_option("--cluster-K",
              type = "numeric"), 
  make_option("--cluster-sigma",
              type = "numeric"),
  make_option("--cluster-t",
              type = "numeric"),
  make_option("--cluster-file",
              type = "character"),
  make_option("--cluster-affinity-file",
              type = "character"),
  make_option("--centroid-method",
              type = "character")
...
for (jtype in jacobians) {
  ...
  es_matrix <- MakeEffectSizeMaps(
    jdtype = str_to_title(jtype), model_list = model_list, 
...
W <- similarity_network(x = list_es,
