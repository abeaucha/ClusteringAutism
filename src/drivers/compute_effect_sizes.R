...
option_list <- list(
  make_option(
    ...
    type = "character",
    help = paste(
      "Path to directory containing the images (.mnc) to",
  ...
  make_option(
    ...
    type = "character",
    help = paste(
      "Path to directory in which to save the effect",
      "size images."
    )
  ),
  make_option(
  ...
  make_option(
    ...
    help = paste("Method used to compute effect sizes.", "[default %default]")
  ),
  make_option(
    "--key",
    type = "character",
    default = "file",
    help = paste(
      "Primary key between demographics data and",
  ...
  make_option(
    ...
    default = "patients",
    help = paste(
      "Group of participants for which to compute",
  ...
  make_option(
    ...
    default = 3,
    help = paste(
      "Degrees of freedom to use in normative model",
  ...
  make_option(
    "--batch",
    type = "character",
    help = paste("Variables to use in normalization prior to", "modelling.")
  ),
  make_option(
    "--ncontrols",
    type = "numeric",
    help = paste(
      "Number of propensity-matched controls to use when",
  ...
  make_option(
    ...
    type = "character",
    help = paste(
      "File in which to export effect size matrix.",
      "Ignored if NULL."
    )
  ),
  make_option(
    ...
    type = "numeric",
    help = paste(
      "Resolution of the effect size matrix.",
  ...
  make_option(
    ...
    default = "local",
    help = paste(
      "Flag indicating whether to run locally or",
  ...
  make_option(
    "--slurm-mem",
    type = "character",
    help = paste("Memory per CPU  when --execution slurm.", "Example: '16G'")
  ),
  make_option(
    "--slurm-time",
    type = "numeric",
    help = paste(
      "Walltime in minutes for Slurm jobs",
...
if (method == "normative-growth") {
  ...
  files <- propensity_matching_norm(
    imgdir = imgdir,
    demographics = demographics,
    mask = mask,
    outdir = outdir,
