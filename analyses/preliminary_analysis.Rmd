...
```{r}
mouse_file <- '../data/mouse/cluster_signatures/input_space/mouse_cluster_signatures_abs_mean_threshold0.5_inputspace.csv'
human_file <- '../data/human/cluster_signatures/input_space/human_cluster_signatures_abs_mean_threshold0.5_inputspace.csv'
...
latent_space_file <- '../data/similarity/latent_space_100/similarity_hm_abs_mean_threshold0.5_latentspace100.csv'
