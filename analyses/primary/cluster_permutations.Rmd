...
```{r null-dist, fig.width = 10, fig.height = 5}
...
ggplot(df_mouse_clusters_sig,
  ...
  geom_flow(stat = "alluvium", aes.flow = "forward") + 
  geom_stratum() + 
  scale_fill_manual(colors = c("grey50", brewer.pal(n = 9, name = "OrRd")[9]),
                    limits = factor(0:1)) + 
  labs(x = "Number of clusters",
       y = "Number of patients",
       fill = "Number of significant matches",
