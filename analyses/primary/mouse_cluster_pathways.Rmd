...
```{r}
similarity <- list_similarity[[1]]
permutations <- list_permutations[[1]]


# compute_similarity_significance <- function(similarity, permutations) {}
...
outfile <- "pathways_nsignificant.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = 10,
    height = 5)
...
outfile <- "pathways_nsignificant_roc.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = 8,
    height = 8)
...
outfile <- "pathways_nk2_test_set_size.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = 8,
    height = 5)
...
```{r}
outfile <- "pathways_nk2_test_set_size_lt500.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = 8,
    height = 5)
...
```{r}
outfile <- "pathways_genes_ecdf.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = 8,
    height = 5)
...
outfile <- "pathways_nsignificant_roc_B_geq20_lt400.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile,
    width = 8,
    height = 8)
