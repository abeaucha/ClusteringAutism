...
#Similarity pipeline
version <- "v3"
# version <- "v3_HBN_anxiety"
# version <- "v3_HBN_anxietydepression"
# version <- "v3_HBN_depression"
version <- "v3_HBN_learning"
# version <- "v2"
...
mouse_centroid_dirs <- file.path(mouse_pipeline_dir, "cluster_maps")
...
# output_dir <- file.path(output_dir, version, "POND_SickKids_controls")
# output_dir <- file.path(output_dir, version, "HBN_patients")
output_dir <- file.path(output_dir, version, human_params_id)
...
#Human anatomy
human_anat_file <- "../../data/human/registration/v3/reference_files/model_3.0mm.mnc"
...
human_mask <- "../../data/human/registration/v3/reference_files/mask_3.0mm.mnc"
...
for (nk in 2:nk_max) {
  for (k in 1:nk) {
    ...
    ss <- sliceSeries(nrow = 6, ncol = 2, begin = 15, end = 60) %>% 
