...
ggplot(df_PR_AUC, aes(x = -log10(alpha), y = delta, col = factor(k))) + 
    geom_line() + 
  geom_point() + 
  theme_bw()
```
...
ggplot(df_mouse_HG, aes(x = -log10(alpha_human), y = -log10(pval), col = factor(round(-log10(alpha_mouse), 2)))) + 
  geom_line() + 
  geom_point() +
  geom_hline(yintercept = -log10(0.05)) + 
  facet_wrap(~k) + 
