...
human_es_file <- file.path(human_es_dir, "absolute", "effect_sizes.csv")
...
human_umap <- umap(df_human_es_data, n_components = 2, random_state = 1)
...
outfile <- "human_umap_relative.pdf"
outfile <- file.path(output_dir, outfile)
pdf(file = outfile, 
    width = 12,
    height = 10)
