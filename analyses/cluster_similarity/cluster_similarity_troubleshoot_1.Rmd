...
```{r fig.width = 14}
mouse_file <- '../../data/mouse/expression/input_space/MouseExpressionMatrix_voxel_coronal_log2_grouped_imputed_homologs_scaled.csv'
human_file <- '../../data/human/expression/input_space/HumanExpressionMatrix_samples_pipeline_abagen_homologs_scaled.csv'
