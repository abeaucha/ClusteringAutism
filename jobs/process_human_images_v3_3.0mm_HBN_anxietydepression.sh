...
#SBATCH --output=logs/process_human_images_v3_3.0mm_HBN_anxietydepression_%j.out
...
--pipeline-dir data/human/derivatives/v3_HBN_anxietydepression/ \
--input-dir data/human/registration/v3/jacobians_resampled/resolution_3.0/ \
--demographics data/human/registration/v3/subject_info/demographics_HBN_AnxietyDepression.csv \
