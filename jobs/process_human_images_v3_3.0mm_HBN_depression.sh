...
#SBATCH --output=logs/process_human_images_v3_3.0mm_HBN_depression_%j.out
...
--pipeline-dir data/human/derivatives/v3_HBN_depression/ \
--input-dir data/human/registration/v3/jacobians_resampled/resolution_3.0/ \
--demographics data/human/registration/v3/subject_info/demographics_HBN_Depression.csv \
